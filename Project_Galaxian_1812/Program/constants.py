...
image_keys = os.path.join(image_gui, "Keys")  
...
#Image - Gui
IMAGE_ARROW_UP = os.path.join(image_keys, "ARROWUP.png")
IMAGE_ARROW_DOWN = os.path.join(image_keys, "ARROWDOWN.png")
IMAGE_ARROW_LEFT = os.path.join(image_keys, "ARROWLEFT.png")
IMAGE_ARROW_RIGHT = os.path.join(image_keys, "ARROWRIGHT.png")
...
IMAGE_M = os.path.join(image_keys, "M.png")
IMAGE_P = os.path.join(image_keys, "P.png")
IMAGE_SOUND_OFF = os.path.join(image_gui, "Sound_Off_Gui.png")
IMAGE_SOUND_ON = os.path.join(image_gui, "Sound_On_Gui.png")
IMAGE_SPACE = os.path.join(image_keys, "SPACEALTERNATIVE.png")
